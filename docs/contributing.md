...
`physdes-py` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/physdes-py
[issue tracker]: https://github.com/<USERNAME>/physdes-py/issues
