"""
Polygon module for 2D polygon creation, manipulation, and analysis.

Provides the ``Polygon`` class (origin + vector representation) and functions
for monotone polygon construction, convex hull computation, orientation
detection, and point-in-polygon (ray-casting) queries.
"""
