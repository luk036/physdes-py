"""
Vector2 class for 2D vector arithmetic.

Provides component-wise addition, subtraction, scalar multiplication/division,
cross product, and equality comparison. Components can be scalars or nested
Vector2 objects (for higher-dimensional vectors).
"""
