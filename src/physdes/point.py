"""
Point class for 2D coordinate representation.

Provides a generic 2D point with operations for vector arithmetic, overlap detection,
containment checks, hull computation, Manhattan distance, and intersection.
Coordinates can be scalars or Intervals (for rectangle-like behavior).
"""
