...
def visualize_routing_tree_svg(
    ...
    def draw_connections(node: "RoutingNode") -> None:
        for child in node.children:
            ...
            # Draw line
            svg_parts.append(f'<line x1="{x_start}" y1="{y_start}" x2="{x_end}" y2="{y_end}" stroke="black" stroke-width="2" marker-end="url(#arrowhead)"/>')
    ...
    for node in all_nodes:
        ...
        # Draw coordinates
        svg_parts.append(f'<text x="{x_pos}" y="{y_pos - radius - 5}" font-family="Arial" font-size="8" fill="gray" text-anchor="middle">({node.pt.xcoord},{node.pt.ycoord})</text>')
...
def visualize_routing_tree3d_svg(
    ...
    def draw_connections(node: "RoutingNode") -> None:
        for child in node.children:
            ...
            # Draw line
            svg_parts.append(f'<line x1="{x_start}" y1="{y_start}" x2="{x_end}" y2="{y_end}" stroke="{color}" stroke-width="2" marker-end="url(#arrowhead)"/>')
    ...
    for node in all_nodes:
        ...
        # Draw coordinates
        svg_parts.append(f'<text x="{x_pos}" y="{y_pos - radius - 5}" font-family="Arial" font-size="8" fill="gray" text-anchor="middle">({node.pt.xcoord.xcoord},{node.pt.ycoord})</text>')
