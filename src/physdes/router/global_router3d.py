...
from physdes.router.routing_tree3d import GlobalRoutingTree3d
from physdes.point import Point


class GlobalRouter3d:
    """
    ...
    def __init__(
        self,
        source_position: Point[Point[int, int], int],
        terminal_positions: List[Point[Point[int, int], int]],
    ) -> None:
        """
        ...
        self.tree = GlobalRoutingTree3d(source_position)
