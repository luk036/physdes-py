"""
Interval class representing a numeric range with lower and upper bounds.

Provides set-like operations (overlap, containment, hull, intersection) and
arithmetic operations (addition, subtraction, multiplication, division) on
intervals and scalars. Also includes free-standing utility functions ``hull``
and ``enlarge`` that work with both Interval objects and plain scalars.
"""
