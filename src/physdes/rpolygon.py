"""
RPolygon class and utilities for rectilinear polygons.

Rectilinear (axis-aligned) polygon with origin+vector representation. Includes
monotone creation, monotone/convex hull computation, point-in-polygon testing,
