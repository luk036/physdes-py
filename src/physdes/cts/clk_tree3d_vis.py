...
class ClockTree3dVisualizer:
    ...
    def _draw_nodes(
        ...
        def draw_nodes_recursive(node, depth=0):
            ...
            is_sink = (node.position.xcoord.xcoord, node.position.ycoord) in sink_positions
...
def create_comparison_visualization(
    ...
    Examples:
        ...
        >>> tree3d1 = TreeNode("root1", Point(50, 50))
        >>> tree3d2 = TreeNode("root2", Point(150, 50))
    ...
    for i, tree_data in enumerate(trees_data):
        ...
        for j, line in enumerate(lines):
            if '<g class="clock-tree3d">' in line:
                ...
                start_idx != -1 and "</g>" in line and "clock-tree3d" not in lines[j - 1]
            ):
                end_idx = j
                break
