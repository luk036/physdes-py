...
def test_merge_2():
    ...
    r1 = a.enlarge_with(3)
    assert r1 == MergeObj(Interval(-4, 2), Interval(6, 12))
    r2 = b.enlarge_with(4)
    assert r2 == MergeObj(Interval(-6, 2), Interval(12, 20))
    r3 = r1.intersect_with(r2)
    assert r3 == MergeObj(Interval(-4, 2), Interval(12, 12))
