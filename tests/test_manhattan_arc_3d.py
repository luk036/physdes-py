...
class TestManhattanArc3DInit:
    ...
    def test_init_with_scalars(self) -> None:
    ...
    def test_init_with_intervals(self) -> None:
...
class TestManhattanArc3DConstruct:
    ...
    def test_construct_with_zero(self) -> None:
    ...
    def test_construct_with_negative(self) -> None:
...
class TestManhattanArc3DFromPoint:
    ...
    def test_from_point_3d(self) -> None:
        inner = Point(8, 6)
        pt = Point(inner, 10)
...
class TestManhattanArc3DOperations:
    ...
    def test_min_dist_with_scalars(self) -> None:
    ...
    def test_min_dist_with_intervals(self) -> None:
    ...
    def test_enlarge_with_zero(self) -> None:
        arc = ManhattanArc3D(12, -4, 2, 6)
        r = arc.enlarge_with(0)
        assert r.w_i == Interval(12, 12)
        assert r.x_i == Interval(-4, -4)

    def test_enlarge_with_intervals(self) -> None:
        w = Interval(10, 20)
        x = Interval(-5, 5)
        y = Interval(0, 10)
        z = Interval(5, 15)
    ...
    def test_intersect_with(self) -> None:
    ...
    def test_intersect_with_no_overlap(self) -> None:
    ...
    def test_merge_with_large_alpha(self) -> None:
...
class TestManhattanArc3DToPoint:
    ...
    def test_to_point_with_intervals(self) -> None:
...
class TestManhattanArc3DCorners:
    ...
    def test_get_lower_corner(self) -> None:
    ...
    def test_get_upper_corner(self) -> None:
...
class TestManhattanArc3DNearest:
    ...
    def test_nearest_point_to(self) -> None:
    ...
    def test_nearest_point_to_origin(self) -> None:
...
class TestManhattanArc3DEdgeCases:
    ...
    def test_min_dist_with_zero_distance(self) -> None:
