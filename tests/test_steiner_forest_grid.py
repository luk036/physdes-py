...
from experimental.steiner_forest_grid import steiner_forest_grid
...
def test_steiner_forest_grid():
    ...
    expected_cost = 17.0
    expected_F_pruned = [(0, 1, 1.0), (1, 2, 1.0), (4, 5, 1.0), (18, 26, 1.0), (25, 26, 1.0), (25, 33, 1.0), (36, 37, 1.0), (39, 47, 1.0), (53, 61, 1.0), (2, 3, 1.0), (2, 10, 1.0), (3, 4, 1.0), (10, 18, 1.0), (37, 38, 1.0), (37, 45, 1.0), (38, 39, 1.0), (45, 53, 1.0)]
