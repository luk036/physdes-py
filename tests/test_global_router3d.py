...
def test_route_with_steiner():
    ...
    terminals = [
        Point(Point(xcoord, randint(0, 3) * scale_z), ycoord) for xcoord, ycoord in coords
    ]
    src_coord = hgen.pop()
    ...
    # Generate and print SVG
    svg_output = visualize_routing_tree3d_svg(router.tree, scale_z, width=1000, height=1000)
    print(svg_output)
